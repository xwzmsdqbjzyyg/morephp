 ...
 * @return object
 */	
function D($tabname,$databasename='cms'){
	yzm_base::load_sys_class('db_factory', '', 0);
	return db_factory::get_instance()->connect($tabname,$databasename);
}
...
function setcache($name, $data, $type = 1, $filepath = '', $timeout=0) {
    ...
    if($filepath != '')  cache_file::setcachedir(YZMPHP_PATH.'cache/chche_file/'.$filepath);
